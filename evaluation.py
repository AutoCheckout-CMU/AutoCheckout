...
if __name__ == "__main__":
    ...
    # dbs += ['cps-test-19', 'cps-test-20','cps-test-21','cps-test-22','cps-test-24'] # TODO: cps-test-23 exception
    dbs = ['ALL-SIMPLE-CHIP-1', 'TEAM-PEI-1', 'TEAM-PEI-JD-1', 'TEAM-8-1']
    dbs += ['BASELINE-1','BASELINE-2','BASELINE-3', 'BASELINE-4', 'BASELINE-5', 'BASELINE-6']
