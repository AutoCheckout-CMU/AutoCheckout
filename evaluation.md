...
# TODO BASELINE-1: 1.0. 1 person. Pick 1 item at gondola 3, pick 1 item at gondola 1, pick 1 item at gondola 2.
# TODO BASELINE-2: 1.0. 1 person. Pick 1 item at gondola 3, pick 1 item at gondola 2, pick 1 item at gondola 1.
# TODO BASELINE-3: 1.0. 1 person. Pick 1 item at gondola 3, puback; pick 1 item at gondola 2, pick 1 item at gondola 1, pick 1 item at gondola 3.
# TODO BASELINE-4: 0.75. 1 person. Pick 1 item at gondola 3, pick 3 items at gondola 2 sequentially, putback 1 item to the correct place.
# TODO BASELINE-5 0.69. [Difficult]: 1 person. Pick 1 green water at gondola 3, puback to wrong place, where there're red water with same weights; from this place, pickup 1 red water, and the misplaced green water. Pickup 1 item from gondola 1.
# TODO BASELINE-6 1.0. [Difficult]: 1 person. Pick 1 big water at gondola 1, put back to wrong place where there're many small water. Pick 2 small water. Pickup 1 item at gondola 3, put back to wrong place at gondola 2, then repick this misplaced item.
# TODO BASELINE-7 0.75.: 2 people. Each pick some items. May have crossing hands issue.
# TODO BASELINE-8 0.83.: 2 people. Each pick some items. Stay very close, may have crossing hands issue.
# TODO BASELINE-9 0.33.: 2 people. Each pick some items. Stay very close, exchange items between them.
# TODO BASELINE-10 0.67.: 2 people. Simultaneously pickup 1 same item each from the same place. Simultaneously pickup 1 different item each from the same shelf. 
# TODO BASELINE-11 1.0.: 3 people. Very complicated.
# TODO BASELINE-12 0.25.: 3 people. Very complicated.

# TODO BASELINE-13 1.0.: 1 person. Pick up two very close but different product.
# TODO BASELINE-14 1.0.: 1 perosn. Very simple case, not sure why wrong.
# TODO BASELINE-15: 1.0. 1 person. Simple.
# TODO BASELINE-16: 0.4. 1 person. Misplaced items and close weight.
# TODO BASELINE-17: 0.28. 1 person. Hold an item for very long time and pick it up.
...
# TODO BASELINE-20: 1.0. 1 person. Pick up three very close but different product, then putback one.
# TODO BASELINE-21: 0.85. 1 person. Very quickly pick up N close items one by one, then putback one.
# TODO BASELINE-22: 0.25. 1 person. Slowly pickup 1 item.
# TODO BASELINE-23[Urgent]: 0.75. 1 person. Putback item and retake, should be simple.
# TODO BASELINE-24: 1.0. 1 person. Pick up two very close but different product.
# TODO BASELINE-25[Urgent]: 0.8. 1 person. Pick 4 items, one by one, simple.
...
# TODO BASELINE-29: 1.0. 1 person. Pick up adjacent items quickly.
# TODO BASELINE-30: 0.80. 1 person. Pick 3 items, leave 1 at floor.
...
# TEAM-3-DAY-2-TEST-1. 0.0: empty receipt
